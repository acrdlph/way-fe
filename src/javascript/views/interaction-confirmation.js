...
class InteractionConfirmation extends React.Component {
  ...
  render() {
    const {
      initiated, pending, successful, data,
    } = this.props.confirmInteractionStore;
    ...
    if (!initiated) {
      ...
      content = (
        <div>
          ...
          <div>
            <NavLink to="/signup">
              <RaisedButton backgroundColor="#68a0ce" label="Join Chat" />
            </NavLink>
          </div>
        </div>
      );
      ...
      content = (
        <div>
          ...
          <div>
            <NavLink to="">
              <RaisedButton backgroundColor="#68a0ce" label="OK" />
            </NavLink>
          </div>
        </div>
      );
    ...
    return <div className="interaction-confirmation">{content}</div>;
  }
}
